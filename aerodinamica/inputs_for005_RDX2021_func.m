...
if Inputfor005.FINSET1.has == 1 % se possue canares
    ...
    InputEmpenas.SPAN = dados.empena; % ## INPUT ## Semi envergadura da Empena, em (m)
...
%% 5. $PROBUT: Airbrake and protuberances
Inputfor005.AIRBRAKE.hasAirbrake = dados.hasAirbrake;
Inputfor005.AIRBRAKE.nBrakes = dados.nBrakes;
Inputfor005.AIRBRAKE.positionBrakes = dados.positionBrakes;
Inputfor005.AIRBRAKE.lBrakes = dados.lBrakes;
Inputfor005.AIRBRAKE.wBrakes = dados.wBrakes;
Inputfor005.AIRBRAKE.hBrakes = dados.hBrakes;

for005.AIRBRAKE = Inputfor005.AIRBRAKE;

plot_geometria(for005,InputEmpenas,OutEmpenas)

%% 6. $DEFLCT: Panel incidence (deflection) values
Inputfor005.DEFLCT.hasDELTA1 = 0;
Inputfor005.DEFLCT.DELTA1 = [0,0,0,0];
Inputfor005.DEFLCT.hasDELTA2 = 0;
Inputfor005.DEFLCT.hasXHINGE = 0;
Inputfor005.DEFLCT.XHINGE = 2.342;

for005.DEFLCT = Inputfor005.DEFLCT;

%% 7. $FLTCON: Flight Conditions (Angles of attack, Altitudes, etc.)
